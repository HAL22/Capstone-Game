...
public class SpawnManager : MonoBehaviour {
    ...
    void spawnUnits()
    {
        ...
        unit.GetComponent<MinionAI>().setMinionData(0, tower[1], unitLayer[1], 1, projectile);
        ...
        unit.GetComponent<MinionAI>().setMinionData(1, tower[0], unitLayer[0], 1, projectile);
